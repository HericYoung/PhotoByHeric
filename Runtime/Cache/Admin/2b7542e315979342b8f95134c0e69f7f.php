...
<head>
	...
	<link rel="stylesheet" href="<?php echo (ADMIN_CSS_URL); ?>morris.css" type="text/css"/>
	<!-- Graph CSS -->
...
<div class="page-container">
	...
	<div class="left-content">
		<div class="mother-grid-inner header-main">
						...
						<div class="card-body p-b-20">
							<div class="list-group">
								<a class="list-group-item media" href="">
									<div class="pull-left">
										<img class="lg-item-img" src="<?php echo (ADMIN_IMG_URL); ?>in1.jpg" alt="">
									</div>
								...
								<a class="list-group-item media" href="">
									<div class="pull-left">
										<img class="lg-item-img" src="<?php echo (ADMIN_IMG_URL); ?>in2.jpg" alt="">
									</div>
									<div class="media-body">
										<div class="pull-left">
								...
								<a class="list-group-item media" href="">
									<div class="pull-left">
										<img class="lg-item-img" src="<?php echo (ADMIN_IMG_URL); ?>in3.jpg" alt="">
									</div>
									<div class="media-body">
										<div class="pull-left">
								...
								<a class="list-group-item media" href="">
									<div class="pull-left">
										<img class="lg-item-img" src="<?php echo (ADMIN_IMG_URL); ?>in4.jpg" alt="">
									</div>
									<div class="media-body">
										<div class="pull-left">
	...
	<div class="sidebar-menu">
		...
		<div class="menu">
			<ul id="menu" >
				...
				<li id="menu-academico" ><a href="fileManagement.html"><i class="fa fa-folder-open-o nav_icon"></i><span>File Management</span><div class="clearfix"></div></a></li>
...
<!-- /Bootstrap Core JavaScript -->
<!-- morris JavaScript -->
<script src="<?php echo (ADMIN_JS_URL); ?>raphael-min.js"></script>
